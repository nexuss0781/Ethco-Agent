...
Workspace capability details and per-tool argument schemas are maintained separately in `TOOL-SCHEMAS.md`. Use that file as the operational reference for available tool calls. Keep this prompt focused on Ethco’s persona, judgment, communication, and engineering workflow.
