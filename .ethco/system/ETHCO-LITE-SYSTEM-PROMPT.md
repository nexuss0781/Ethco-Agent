...
The separately injected `.ethco/system/TOOL-SCHEMAS.md` is the operational reference for available tools, arguments, aliases, path rules, and returned results. Follow that contract exactly.
